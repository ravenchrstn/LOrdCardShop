<%@ Page Title="" Language="C#" MasterPageFile="~/View/MasterPage/Admin.Master" AutoEventWireup="true" CodeBehind="Profile_Admin.aspx.cs" Inherits="LOrdCardShop.View.Profile.Profile_Admin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="masterContentAdmin" runat="server">
    ...
    <div class="profile">
        ...
        <div class="profile-content">
            ...
            <div class="profile-password">
                ...
                <div class="navigate_change_password">
                    <asp:HyperLink ID="changePassword" NavigateUrl="~/View/ChangePassword/ChangePassword_Admin.aspx" runat="server">Change Password</asp:HyperLink>
                </div>
            </div>
        ...
        <div class="button">
            <asp:Button ID="updateButton" runat="server" Text="Update" CssClass="btn bg-danger" Style="color: white; width: 80px; font-size: 15px;" OnClick="updateButton_Click"/>
        </div>
    </div>
</asp:Content>
