...
{
	public partial class Profile_Customer1 : System.Web.UI.Page
	{
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ac.CustomerAuthentication("~/View/Profile/Profile_Admin.aspx");
                ShowData();
            }
        ...
        protected void updateButton_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/View/Home/Home_Customer.aspx");
        }
    }
}