<%@ Page Title="" Language="C#" MasterPageFile="~/View/MasterPage/Admin.Master" AutoEventWireup="true" CodeBehind="TransactionHistory_Admin.aspx.cs" Inherits="LOrdCardShop.View.TransactionHistory.TransactionHistory_Admin" %>
                                ...
                                <div class="footer">
                                    ...
                                    <div class="detail_container">
                                        <div class="detail_button">
                                            <asp:Button ID="detail_button" runat="server" class="btn bg-danger" Style="width: 75px; color: white" Text="Detail" CommandName="Detail" CommandArgument='<%# Eval("TransactionID") %>' OnCommand="transaction_history_Command"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
