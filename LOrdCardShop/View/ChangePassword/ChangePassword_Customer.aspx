<%@ Page Title="" Language="C#" MasterPageFile="~/View/MasterPage/Customer.Master" AutoEventWireup="true" CodeBehind="ChangePassword_Customer.aspx.cs" Inherits="LOrdCardShop.View.ChangePassword.ChangePassword_Customer" %>
